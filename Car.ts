...
export class Car extends THREE.Object3D
{
    ...
    public update(deltaTime : number) : void
    {
        ...
        */
        if(this.position.x < -40 + this.collisionRadius){
            this.velocity.setZ(0);
            this.position.setX(-40 + this.collisionRadius);
        }
        ...
        if(this.position.z < -50 + this.collisionRadius){
            this.velocity.setZ(0);
            this.position.setZ(-50 + this.collisionRadius);
        }
